...
import {
  hideUpdatePurchaseIngredientModal,
  setCancelEditPurchaseIngredient,
  updatePurchaseIngredientData,
} from "../../../store/mo/purchaseIngredient";
import "bootstrap/dist/css/bootstrap.min.css";

function ModalUpdatePurchaseIngredient() {
  const show = useSelector(
    (state) => state.purchaseIngredientStore.updatePurchaseIngredientModal
  );
  const data = useSelector(
    (state) => state.purchaseIngredientStore.editPurchaseIngredientData
  );
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      if (totalRef.current) {
        totalRef.current.value = data.total_buy;
      }
    }
  }, [data]);
  ...
  const handleSaveChanges = () => {
    const updatePurchaseIngredient = {
      ...
      total_price: parseInt(totalRef.current.value) * data.price_per_unit,
    };
