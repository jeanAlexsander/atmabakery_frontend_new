    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          {/* deskripsi */}
          <p>It always, and always on, about taste. Our vision is to give the best quality of service and variety of bakery products with high taste and excellence to customers.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2024 Atma Bakery, Inc.  All rights reserved</h3>
