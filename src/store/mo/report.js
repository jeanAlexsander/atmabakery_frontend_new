...
const {setDataReport, setDataReportPerProduct, setDataIngredientsReport, setDataIngredientsPerPeriode, setDataPemasukanPengeluaran, setEmployeeAttendanceSalaryData} = reportSlice.actions;
